...
```bash
go get gopkg.in/daangn/dd-trace-go.v1/...
```
...
The API is documented on [godoc](https://godoc.org/gopkg.in/daangn/dd-trace-go.v1/ddtrace) as well as Datadog's [official documentation](https://docs.datadoghq.com/tracing/setup/go/). If you are migrating
